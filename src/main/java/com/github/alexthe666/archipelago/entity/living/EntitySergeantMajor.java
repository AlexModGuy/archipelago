...
public class EntitySergeantMajor extends EntityAquaticAnimal {

    public EntitySergeantMajor(World world) {
    ...
    public String getTexture() {
        return "archipelago:textures/models/sergeant_major/sergeant_major_" + this.getVariant();
    }
}
