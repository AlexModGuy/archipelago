...
public class EntityGreenSeaTurtle extends EntityAquaticAnimal {

    public EntityGreenSeaTurtle(World world) {
    ...
    @Override
    public void onSpawn(){this.setVariant(0);}



    @Override
    public String getTexture() {
        return "archipelago:textures/models/green_sea_turtle/green_sea_turtle_" + this.getVariant();
    }
}
