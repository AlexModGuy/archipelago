...
public class ModBlocks {
    ...
    public static void init() {
        ...
        allamanda_angustifolia = new BlockShortPlant("allamanda_angustifolia", 5, new Biome[] { ModWorld.tropicGrasslands, ModWorld.tropicJungle });
        aztec_marigold_red = new BlockShortPlant("aztec_marigold_red", 5, new Biome[] { ModWorld.tropicGrasslands, ModWorld.tropicJungle });
        aztec_marigold_orange = new BlockShortPlant("aztec_marigold_orange", 5, new Biome[] { ModWorld.tropicGrasslands, ModWorld.tropicJungle });
        aztec_marigold_yellow = new BlockShortPlant("aztec_marigold_yellow", 5, new Biome[] { ModWorld.tropicGrasslands, ModWorld.tropicJungle });
        fever_root = new BlockShortPlant("fever_root", 5, new Biome[] { ModWorld.tropicGrasslands, ModWorld.tropicJungle });
        hibiscus = new BlockTallPlant("hibiscus", 5, new Biome[] { ModWorld.tropicGrasslands, ModWorld.tropicJungle });
        kakhiweed = new BlockShortPlant("kakhiweed", 5, new Biome[] { ModWorld.tropicGrasslands });
        lafoensia_pacari = new BlockTallPlant("lafoensia_pacari", 5, new Biome[] { ModWorld.tropicGrasslands, ModWorld.tropicJungle });
        lily_of_the_valley = new BlockTallPlant("lily_of_the_valley", 5, new Biome[] { ModWorld.tropicGrasslands, ModWorld.tropicJungle });
        monstera_deliciosa = new BlockTallPlant("monstera_deliciosa", 5, new Biome[] { ModWorld.tropicGrasslands, ModWorld.tropicJungle });
        pau_santo = new BlockTallPlant("pau_santo", 5, new Biome[] { ModWorld.tropicGrasslands, ModWorld.tropicJungle });
        ...
        bougainvillea_pink = new BlockTallPlant("bougainvillea_pink", 5, new Biome[] { ModWorld.tropicGrasslands, ModWorld.tropicJungle });
        bougainvillea_white = new BlockTallPlant("bougainvillea_white", 5, new Biome[] { ModWorld.tropicGrasslands, ModWorld.tropicJungle });
        bowenia_spectabilis = new BlockTallPlant("bowenia_spectabilis", 5, new Biome[] { ModWorld.tropicGrasslands, ModWorld.tropicJungle });
        flamingo_flower = new BlockTallPlant("flamingo_flower", 5, new Biome[] { ModWorld.tropicGrasslands, ModWorld.tropicJungle });
        kalmashi = new BlockShortPlant("kalmashi", 5, new Biome[] { ModWorld.tropicJungle });
        ...
        shyleaf = new BlockTallPlant("shyleaf", 5, new Biome[] { ModWorld.tropicJungle });
        smokebush = new BlockTallPlant("smokebush", 5, new Biome[] { ModWorld.tropicJungle });
        ...
        west_indian_lilac = new BlockTallPlant("west_indian_lilac", 5, new Biome[] { ModWorld.tropicGrasslands, ModWorld.tropicJungle });
