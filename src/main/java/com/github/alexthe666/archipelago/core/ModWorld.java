...
public class ModWorld {
    ...
    public static void init() {
        ...
        mangroveSwamp = new BiomeGenTropical("Mangrove Swamp", ModConfig.mangroveSwampId, -0.15F, 0.1F, 0x46FFFF, TropicGrassColor.SWAMP, TropicBiomeSediment.GRASSY, new BiomeGenTropical.TreeGenerator((rand) -> new WorldGenCoconutPalm(), 10), new BiomeGenTropical.TreeGenerator((rand) -> new WorldGenMangrove(), 10)).setTreesPerChunk(1).setGenerationChance(7);
        tropicLakes = new BiomeGenTropical("Tropic Lakes", ModConfig.tropicLakes, -0.4F, 0.15F, 0x46FFFF, TropicGrassColor.CLASSIC_TROPICAL, TropicBiomeSediment.GRASSY, new BiomeGenTropical.TreeGenerator((rand) -> new WorldGenCoconutPalm(), 10)).setTreesPerChunk(1);
