...
public class ModWorld {
    ...
    public static void init() {
        ...
        blackSandBeach = new BiomeGenTropical("Black Sand Beach", ModConfig.blackSandBeachId, 0.1F, 0.05F, 0x46FFFF, TropicGrassColor.BURNT, TropicBiomeSediment.VOLCANIC);
