...
public class ModWorld {
    ...
    public static void init() {
        ...
        ashField = new BiomeGenTropical("Ash Field", ModConfig.ashFieldId, 0.175F, 0.05F, 0x46FFFF, TropicGrassColor.BURNT, TropicBiomeSediment.VOLCANIC);
        volcano = new BiomeGenTropical("Volcano", ModConfig.volcanoId, 0.1F, 0.05F, 0x46FFFF, TropicGrassColor.BURNT, TropicBiomeSediment.VOLCANIC);
