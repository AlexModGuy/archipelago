...
public class ModWorld {
	...
	public static void init(){
		...
		tropicBeach = new BiomeGenTropical("Tropic Beach", ModConfig.tropicBeachId, 0.4F, 0.025F, EnumGrassColor.CLASSIC_TROPICAL, EnumBiomeSediment.SANDY);
		tropicGrasslands = new BiomeGenTropical("Tropic Grasslands", ModConfig.tropicGrasslandsId, 0.4F, 0.025F, EnumGrassColor.CLASSIC_TROPICAL, EnumBiomeSediment.GRASSY);
		tropicShrublands = new BiomeGenTropical("Tropic Shrublands", ModConfig.tropicShrublandsId, 0.425F, 0.05F, EnumGrassColor.CLASSIC_TROPICAL, EnumBiomeSediment.GRASSY);
		tropicJungle = new BiomeGenTropical("Tropic Jungle", ModConfig.tropicJungleId, 0.425F, 0.05F, EnumGrassColor.CLASSIC_TROPICAL, EnumBiomeSediment.GRASSY);
		dryPeaks = new BiomeGenTropical("Dry Peaks", ModConfig.dryPeaksId, 0.5F, 0.2F, EnumGrassColor.DRY, EnumBiomeSediment.GRASSY);
		dryScrubland = new BiomeGenTropical("Dry Scrublands", ModConfig.dryScrublandId, 0.525F, 0.05F, EnumGrassColor.DRY, EnumBiomeSediment.GRASSY);
		ashField = new BiomeGenTropical("Ash Field", ModConfig.ashFieldId, 0.525F, 0.05F, EnumGrassColor.BURNT, EnumBiomeSediment.GRASSY);
		volcano = new BiomeGenTropical("Volcano", ModConfig.volcanoId, 0.7F, 0.05F, EnumGrassColor.BURNT, EnumBiomeSediment.GRASSY);
